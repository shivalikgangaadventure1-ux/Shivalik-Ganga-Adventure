...
import { LifeBuoy, ShieldCheck, Siren, Users2 } from "lucide-react";
...
const SAFETY_POINTS = [
  ...
  },
  {
    ...
    description: "A trained guide leads each raft, briefing your group on paddling commands and river safety before launch.",
  },
  {
    icon: LifeBuoy,
